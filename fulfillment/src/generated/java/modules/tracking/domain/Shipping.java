...
@XmlType
@XmlRootElement
public class Shipping extends AbstractPersistentBean {
	/**
	 * For Serialization
	 * @hidden
	 */
	...
	/** @hidden */
	public static final String DOCUMENT_NAME = "Shipping";
	...
	public String getBizModule() {
		return Shipping.MODULE_NAME;
	}

	@Override
	@XmlTransient
	public String getBizDocument() {
		return Shipping.DOCUMENT_NAME;
	}
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("Shipping", this);
		}
	...
	public boolean equals(Object o) {
		return ((o instanceof Shipping) && 
					this.getBizId().equals(((Shipping) o).getBizId()));
	}
