...
@XmlType
@XmlRootElement
public class Picking extends AbstractPersistentBean {
	/**
	 * For Serialization
	 * @hidden
	 */
	...
	/** @hidden */
	public static final String DOCUMENT_NAME = "Picking";
	...
	public String getBizModule() {
		return Picking.MODULE_NAME;
	}

	@Override
	@XmlTransient
	public String getBizDocument() {
		return Picking.DOCUMENT_NAME;
	}

	public static Picking newInstance() {
		try {
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("Picking", this);
		}
	...
	public boolean equals(Object o) {
		return ((o instanceof Picking) && 
					this.getBizId().equals(((Picking) o).getBizId()));
	}
