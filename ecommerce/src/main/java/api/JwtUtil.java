...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000* 60*20 ))//System.currentTimeMillis() + 1000 * 60 * 60 * 10
    ...
    public Boolean validateToken(String token, UserLogin userDetails) {
        ...
        //System.out.println("username.equals(userDetails.getUserloginid() = "+username.equals(userDetails.getUserloginid()));
